...
export type SignatureAlgorithm = 'RSA-PSS-SHA256' | 'ECDSA-SECP384R1-SHA384' | 'ECDSA-SECP256R1-SHA256' | 'ED25519' | 'RSA-PKCS1-SHA512' | 'RSA-PKCS1-SHA256';
...
export type Crypto = {
     ...
     */
    encrypt(cipherSuite: SymmetricCryptoAlgorithm, opts: CryptOptions): Awaitable<Uint8Array>;
    decrypt(cipherSuite: SymmetricCryptoAlgorithm, opts: CryptOptions): Awaitable<Uint8Array>;
    authenticatedEncrypt(cipherSuite: AuthenticatedSymmetricCryptoAlgorithm, opts: AuthenticatedCryptOptions): Awaitable<{
        ciphertext: Uint8Array;
        authTag: Uint8Array;
    }>;
    authenticatedDecrypt(cipherSuite: AuthenticatedSymmetricCryptoAlgorithm, opts: AuthenticatedCryptOptions): Awaitable<{
